...
export const rawQuests: IRawQuest[] = shuffleQuestsByWeek([
  {
    ...
    description:
      "We don't know how long all these people are going to be trapped here. If we don't feed them, we're going to have a riot on our hands. Riots are terrible for business.",
    parties: [
      {
        id: "p1-q4-10",
        startWeek: 4,
  ...
  },
  {
    ...
    description:
      "\"There is a strange affliction spreading through the city. People suddenly collapsing. Then if they don't receive treatment, their trunk and neck are covered in dark, spidering lesions. We're nearly out of medicinal herbs. May the holy mother save us all.\"",
    parties: [
      {
        id: "p1-q4-5",
        startWeek: 4,
  ...
  },
  {
    ...
    description:
      "Look, the town walls are pretty strong. But with all these trapped civilians, if even one of these tough monsters gets in here, it's going to be bad time.",
    parties: [
      {
        id: "p1-q4-7",
        startWeek: 4,
      ...
      { id: "p3-q4-7", startWeek: 4, status: "Claimed", metrics: [] },
      {
        id: "p4-q4-7",
        startWeek: 4,
        clanId: "c9",
  ...
  },
  {
    ...
    postedBy: "Gorn Wigby",
    description:
      '"It appears the noisy gnat is spawning a brood. Those close to me are, not accustomed to such... discomfort. A talented (and discrete) pest handler would be well appreciated."',
    parties: [
      {
        id: "p1-q4-4",
        startWeek: 4,
  ...
  },
  {
    ...
    postedBy: "Various",
    description:
      "The board is covered with missing persons postings. It doesn't help that the there are over five times as many people in the walls as usual. Most of whom are not familiar with the city, but that alone wouldn't account for this volume.",
    parties: [
      {
        id: "p1-q4-8",
        startWeek: 4,
  ...
  },
  {
    ...
    description:
      '"The Azure Wolf Father, Mamut, must be returned to the Sacred Grove, or things will only get worse. He was in the town square, but where is he now?"',
    parties: [
      {
        id: "p1-q4-2",
        startWeek: 4,
  ...
  },
  {
    ...
    description:
      '"Something is amiss in the city Graveyard. Bodies have been exhumed. Please keep watch, and may the holy mother watch you."',
    parties: [
      {
        id: "p1-q4-1",
        startWeek: 4,
  ...
  },
  {
    ...
    description:
      "Now we all know that the city is on lockdown. It's not safe to leave. We would never think of trying. But perhaps some enterprising adventurers would be willing to... show some out of town merchants like ourselves around town? Just a tour of the city and nothing more. We would pay handsomely for such a... tour.",
    parties: [
      {
        id: "p1-q4-6",
        startWeek: 4,
  ...
  },
  {
    ...
    description:
      '"Everyone remain calm. Please. Keep order. I know. I know. None of us want to be trapped inside the city walls. I hear you. We are sending some of our best to tell the capitol what\'s happening here."',
    parties: [{ id: "p1-q4-3", startWeek: 4, status: "Claimed", metrics: [] }],
  },
  {
    id: "q3-8",
    name: "Bounty Battle",
    ...
    description:
      "One of the big draws the the Morton Bounty Festival is the one on one fighting tournament. It's a winner takes all event, and happens over the course of the week. Anyone can enter regardless of their skill, rank, social status, or race. Everyone has the right to get kicked in the head.",
    parties: [
      {
        id: "p1-q3-8",
        startWeek: 3,
        ...
        clanId: "c9",
        metrics: [
          { metricRuleId: "QuestFailed", rank: "D", value: 1, week: 3 },
        ],
      },
      {
        id: "p2-q3-8",
      ...
      },
      {
        ...
        startWeek: 3,
        notes:
          "Right before his match with Ken, Sir Robin claimed to have a terrible bout of indigestion. Mara looked at Clara and crossed her arms. The maid squire grumbled, \"Fine... I'll do it.\" Then she stepped in the ring. After beating Ken & Geoffrey soundly she set off against fissure. The fight was almost too fast for people to see. Clara's left arm and leg were quickly paralyzed. But then at the last moment the Fissure went flying out of the ring and smashed into a wall. Clara scowled at Mara, grabbed her bag of gold and ran off without a word.",
        status: "Success",
        clanId: "c1",
      ...
      },
      {
        ...
        startWeek: 3,
        notes:
          'Geoffrey beat punching Steve in the first round. In the second round he was against Clara Kimberflorn. He began the match by saying, "Surely you jest! It wouldn\'t be right for me to fight such a delicate flow-." He awoke 10 minutes later missing a tooth.',
        status: "Failed",
        clanId: "c6",
        metrics: [
          { metricRuleId: "QuestFailed", rank: "D", value: 1, week: 3 },
  ...
  },
  {
    ...
    postedBy: "Trade guild",
    description:
      "It's going to be busy in Morton this week with the festival. We'll need capable people to guard the merchants and their wares.",
    parties: [
      {
        id: "p1-q3-7",
        startWeek: 3,
        ...
        status: "Success",
        clanId: "c6",
        metrics: [{ metricRuleId: "RewardGold", value: 150, week: 3 }],
      },
      {
        id: "p2-q3-7",
        startWeek: 3,
  ...
  },
  {
    ...
    description:
      "It's a cook off! Julia Pepperschild, the iron chef is taking on any challengers. At the festival. The \"Who's cuisine will reign supreme?!\"",
    parties: [
      {
        id: "p1-q3-4",
        startWeek: 3,
        ...
        clanId: "c7",
        metrics: [
          { metricRuleId: "RewardGold", rank: "C", value: 130, week: 3 },
        ],
      },
    ],
  },
  {
    ...
    postedBy: "Elder K'Tar",
    description:
      '"Corruption spreads in the forest. I worry that it will reach the sacred grove."',
    parties: [
      {
        id: "p1-q3-2",
        startWeek: 3,
        ...
        clanId: "c10",
        metrics: [
          { metricRuleId: "QuestFailed", rank: "C", value: 1, week: 3 },
          { metricRuleId: "TrapTriggered", value: 2, week: 3 },
          { metricRuleId: "RewardGold", value: 15, week: 3 },
        ],
      },
    ],
  },
  {
    ...
    description:
      "My husband Charles hasn't been home in a week. Last I heard he was heading out to the sawmill.",
    parties: [],
  },
  {
    id: "q2-5",
    ...
    postedBy: "The Town Guard",
    description:
      "Morton has grown quite a bit since the city wall was erected. So now many of the townsfolk are living outside. With the increased Beast activity from the North the guards are spread thin.",
    parties: [
      {
        id: "p1-q2-5",
        startWeek: 2,
        ...
        clanId: "c9",
        metrics: [
          { metricRuleId: "RewardGold", value: 15, week: 2 },
          { metricRuleId: "CostsOrDamages", value: 7, week: 2 },
      ...
      },
      {
        ...
        status: "Success",
        metrics: [{ metricRuleId: "RewardGold", value: 30, week: 2 }],
      },
      {
        id: "p4-q2-5",
        startWeek: 3,
        ...
        metrics: [
          ...
          { metricRuleId: "CivilianSaved", value: 10, week: 3 },
        ],
      },
      {
        id: "p5-q2-5",
        ...
        metrics: [
          { metricRuleId: "QuestFailed", rank: "D", value: 1, week: 3 },
          { metricRuleId: "CiviliansDead", value: 4, week: 3 },
        ],
      },
      {
        id: "p6-q2-5",
        ...
        metrics: [
          { metricRuleId: "QuestFailed", rank: "D", value: 1, week: 3 },
          { metricRuleId: "CivilianSaved", value: 6, week: 3 },
          { metricRuleId: "CiviliansDead", value: 4, week: 3 },
        ],
      },
    ],
  ...
  },
  {
    ...
    postedBy: "Gorn Wigby",
    description:
      '"There is a pesky fly buzzing by my ear... I would pay handsomely to have it swatted."',
    parties: [
      {
        id: "p1-q3-3",
        startWeek: 3,
        notes:
          "Marcus returned to the guild hall limping, surly, and covered in leaves.",
        status: "Failed",
        clanId: "c2",
        metrics: [
          { metricRuleId: "QuestFailed", rank: "C", value: 1, week: 3 },
    ...
    parties: [
      {
        ...
        clanId: "c3",
        metrics: [
          { metricRuleId: "EnemyDefeat", value: 1, rank: "A", week: 3 },
        ],
      },
    ],
  },
    ...
    parties: [
      {
        ...
        metrics: [
          { metricRuleId: "QuestFailed", rank: "E", value: 1, week: 1 },
        ],
      },
      {
        id: "p2-q1-9",
        ...
        metrics: [
          { metricRuleId: "QuestFailed", rank: "E", value: 1, week: 2 },
        ],
      },
      {
        id: "p3-q1-9",
        ...
        status: "Failed",
        notes:
          'Buster was found jabbering to himself after the festival. When people approached he would grab them and say something along the lines of, "The eyed mouth opens its pupil teeth. We must away to the lightning!"',
        metrics: [
          { metricRuleId: "QuestFailed", rank: "E", value: 1, week: 3 },
        ],
      },
    ],
  },
  {
    ...
    description:
      "As Morton has become a common stop in trade routes, its Bounty festival has grown in popularity. Even people from the larger cities like the major port of Serpetina make the trip to enjoy the festivities. The merchants come in a week early",
    parties: [
      {
        id: "p1-q2-6.1",
        startWeek: 2,
        ...
        clanId: "c1",
        metrics: [
          { metricRuleId: "RewardGold", value: 70, week: 2 },
          { metricRuleId: "CivilianSaved", value: 6, week: 2 },
        ],
      },
    ],
  },
  {
    ...
    description:
      'In transit from the Capitol to Morton, several members of the Counts Retinue went missing during a monster attack near the northern forest. "I wish to know their fate, and will pay a premium if their bodies are returned."',
    parties: [
      {
        id: "p1-q2-2",
        startWeek: 2,
        ...
        clanId: "c2",
        metrics: [
          { metricRuleId: "RewardGold", value: 600, week: 2 },
          { metricRuleId: "CiviliansDead", value: 1, week: 2 },
        ],
      },
    ],
  },
  {
    ...
    postedBy: "Elder K'Tar",
    description:
      '"The cavern housing the mystic spring has been desecrated. I can\'t clean it up by myself."',
    parties: [
      {
        id: "p1-q2-8",
        startWeek: 2,
        ...
        metrics: [
          { metricRuleId: "CivilianSaved", value: 1, week: 2 },
          { metricRuleId: "RewardGold", value: 10, week: 2 },
    ...
    parties: [
      {
        ...
        metrics: [{ metricRuleId: "RewardGold", value: 120, week: 1 }],
      },
      {
        id: "p2-q1-7",
        startWeek: 1,
      ...
      },
      {
        ...
        metrics: [{ metricRuleId: "RewardGold", value: 3, week: 1 }],
      },
      {
        id: "p5-q1-7",
        startWeek: 1,
        ...
        metrics: [{ metricRuleId: "RewardGold", value: 40, week: 1 }],
      },
      {
        id: "p6-q1-7",
        startWeek: 2,
        ...
        metrics: [{ metricRuleId: "RewardGold", value: 110, week: 2 }],
      },
      {
        id: "p7-q1-7",
        startWeek: 2,
      ...
      },
      {
        ...
        metrics: [{ metricRuleId: "RewardGold", value: 7, week: 2 }],
      },
    ],
  },
  {
    ...
    postedBy: "Guildmaster Vahn",
    description:
      "The head of the adventurer guild addressed the increase in monsters to the North of town, \"Hey! Attention! Listen up you crazy buggers! Oh! Sorry didn't mean to hit you with that... Anyway, something's up with the Forest. The monsters are moving out of the depths to the edges near the road. Heck Vince Dawn even caught a greater porcubears near the east check point. Get out there and figure out what the heck is going on. No heroics. We just need info. This is on the guild's tab.\"",
    parties: [
      {
        id: "p1-q2-3",
        startWeek: 2,
        ...
        status: "Success",
        clanId: "c4",
        metrics: [{ metricRuleId: "RewardGold", value: 50, week: 2 }],
      },
      {
        id: "p2-q2-3",
        startWeek: 2,
      ...
      },
      {
        ...
        status: "Success",
        clanId: "c6",
        metrics: [{ metricRuleId: "RewardGold", value: 75, week: 2 }],
      },
    ],
  },
  {
    ...
    description:
      "My Family watch has been stolen! I swear I saw Trimble Dinklesbean with it. The sneak was eyeing it at the lodge hall! I will pay handsomely if someone were to... persuade him... that it should return to its rightful owner.",
    parties: [
      {
        id: "p1-q2-7",
        startWeek: 2,
  ...
  },
  {
    ...
    postedBy: "The Chairman",
    description:
      "To make the ultimate dish: you need the choicest centerpieces! This weeks featured ingredient is... Fish!",
    parties: [
      {
        id: "p1-q2-4",
        startWeek: 2,
  ...
  },
  {
    ...
    postedBy: "The Trade Guild",
    description:
      "As Morton has become a common stop in trade routes, its Bounty festival has grown in popularity. Even people from the royal capitol of Valeon make the trip to enjoy the festivities. The merchants come in a week early",
    parties: [
      {
        id: "p1-q2-6.2",
        startWeek: 2,
        ...
        clanId: "c6",
        metrics: [
          { metricRuleId: "RewardGold", value: 120, week: 2 },
          { metricRuleId: "CivilianSaved", value: 8, week: 2 },
        ],
      },
    ],
  },
  {
    ...
    postedBy: "Mayor Corque",
    description:
      '"Ok, so the rats in the sewer... they combined into what people are telling me is a rat king. And it has, how do I put it diplomatically?... dispatched a couple adventurers and has doubled in size. Thankfully the nobles visiting from the capitol have been kind enough to foot the subjugation bill."',
    parties: [
      {
        id: "p1-q2-1",
        startWeek: 2,
        ...
        status: "Success",
        clanId: "c3",
        metrics: [{ metricRuleId: "RewardGold", value: 200, week: 2 }],
      },
    ],
  },
  {
    ...
    postedBy: "The Trade Guild",
    description:
      "As Morton has become a common stop in trade routes, its Bounty festival has grown in popularity. Even people from the larger cities like the industrial powerhouse Furthbrand make the trip to enjoy the festivities. The merchants come in a week early.",
    parties: [
      {
        id: "p1-q2-6.3",
        startWeek: 2,
        ...
        clanId: "c1",
        metrics: [
          { metricRuleId: "QuestFailed", rank: "D", value: 1, week: 2 },
          { metricRuleId: "CostsOrDamages", value: 200, week: 2 },
          { metricRuleId: "CiviliansDead", value: 3, week: 2 },
        ],
      },
    ],
  },
    ...
    parties: [
      {
        ...
        metrics: [{ metricRuleId: "RewardGold", value: 100, week: 1 }],
      },
    ],
  },
  {
    ...
    parties: [
      {
        ...
        clanId: "c7",
        metrics: [
          { metricRuleId: "EnemyDefeat", value: 1, rank: "B", week: 1 },
        ],
      },
    ],
  },
    ...
    parties: [
      {
        ...
        metrics: [
          ...
          { metricRuleId: "CivilianSaved", value: 9, week: 1 },
        ],
      },
    ],
  },
    ...
    parties: [
      {
        ...
        clanId: "c1",
        metrics: [{ metricRuleId: "RewardGold", value: 27, week: 1 }],
      },
      {
        id: "p2-q1-2",
        startWeek: 1,
        ...
        clanId: "c1",
        metrics: [{ metricRuleId: "RewardGold", value: 41, week: 1 }],
      },
    ],
  },
  {
    ...
    parties: [
      {
        ...
        metrics: [
          { metricRuleId: "RewardGold", value: 1, week: 1 },
          { metricRuleId: "CivilianSaved", value: 1, week: 1 },
        ],
      },
      {
        id: "p2-q1-3",
    ...
    parties: [
      {
        ...
        metrics: [{ metricRuleId: "RewardGold", value: 35, week: 1 }],
      },
      {
        id: "p2-q1-5",
        startWeek: 1,
      ...
      },
      {
        ...
        startWeek: 1,
        status: "Success",
        metrics: [{ metricRuleId: "RewardGold", value: 10, week: 1 }],
      },
    ],
  },
  {
    ...
    parties: [
      {
        ...
        metrics: [
          { metricRuleId: "RewardGold", value: 150, week: 1 },
          { metricRuleId: "CostsOrDamages", value: 30, week: 1 },
          { metricRuleId: "CivilianSaved", value: 12, week: 1 },
        ],
      },
    ],
  },
    ...
    parties: [
      {
        ...
        clanId: "c6",
        metrics: [
          { metricRuleId: "QuestFailed", rank: "B", value: 1, week: 1 },
          { metricRuleId: "CiviliansDead", value: 10, week: 1 },
          { metricRuleId: "CivilianSaved", value: 12, week: 1 },
          { metricRuleId: "CostsOrDamages", value: 112, week: 1 },
        ],
      },
    ],
  },
