...
export const questsByPartyId = rawQuests.reduce((prev, q)=>{
...
export const questsByClanId = rawQuests.reduce((prev, q)=>{
...
export const questsByAdventurerId = rawAdventurers.reduce((prev, a)=>{
